...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium tax, audit, GST, and corporate advisory for founders, enterprises, and high-net-worth individuals." },
      { name: "author", content: "Arjun Mehta" },
      { property: "og:title", content: "Arjun Mehta, FCA — Chartered Accountant & Business Advisor" },
      { property: "og:description", content: "Premium tax, audit, GST, and corporate advisory for founders, enterprises, and high-net-worth individuals." },
